...
# Import common configuration functionality
from libs.common.config import config as common_config
...
class Config:
    ...
    def get_service_url(self, service: str) -> str:
        """Get service URL with environment variable override and common library fallback"""
        # First try deepsearch-specific config
        ...
        # Then try the common config
        return common_config.get_service_url(service)
