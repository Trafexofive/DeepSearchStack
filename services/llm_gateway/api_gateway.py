...
async def get_completion(
    ...
    try:
        ...
        # Extract tokens used from response - handle both dict and Usage object formats
        tokens_used = None
        if hasattr(response, 'usage') and response.usage:
            if hasattr(response.usage, 'total_tokens'):  # Enhanced Usage object
                tokens_used = response.usage.total_tokens
            elif isinstance(response.usage, dict) and 'total_tokens' in response.usage:  # Dict format
